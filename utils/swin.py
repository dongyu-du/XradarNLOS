"""
SwinUNet architecture for Range-Azimuth heatmap prediction.

Exports:
    SwinTransformerSys  — full encoder-decoder architecture
    SwinUnet            — thin wrapper with 3-channel replication and standard config
"""
...
class SwinUnet(nn.Module):
    """SwinTransformerSys with standard radar config and 1→3 channel replication."""

    def __init__(self, img_size: int = 512, num_classes: int = 2):
        super().__init__()
